...
<div class="max-w-3xl mx-auto py-10 px-4">
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        @forelse($conversations as $conv)
            <a href="{{ route('doctor.messages.show', $conv) }}"
               class="flex items-center gap-4 p-5 border-b border-gray-100 hover:bg-gray-50 transition last:border-0">
                ...
                <div class="flex-1 min-w-0">
                    <p class="font-medium text-gray-800">{{ $conv->patient->name }}</p>
        ...
        @empty
            <div class="p-10 text-center text-gray-400 text-sm">Aucune conversation.</div>
        @endforelse
    </div>
</div>
</body>
